...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOA, LED_RED_Pin|LED_GREEN_Pin);
  ...
  /**/
  LL_GPIO_SetPinPull(EYE_GPIO_Port, EYE_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(EYE_GPIO_Port, EYE_Pin, LL_GPIO_MODE_INPUT);
